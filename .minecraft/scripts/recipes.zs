...
//Don't touch me!
//#Add
recipes.addShaped(<minecraft:golden_apple:1>, [[<minecraft:gold_block>, <nyx:fallen_star>, <minecraft:gold_block>],[<minecraft:potion>.withTag({Potion: "minecraft:strong_regeneration"}).onlyWithTag({Potion: "minecraft:strong_regeneration"}), <minecraft:golden_apple>, <minecraft:potion>.withTag({Potion: "minecraft:strong_regeneration"}).onlyWithTag({Potion: "minecraft:strong_regeneration"})], [<minecraft:gold_block>, <minecraft:gold_block>, <minecraft:gold_block>]]);
